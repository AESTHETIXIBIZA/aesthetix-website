...
export const metadata: Metadata = {
  title: 'Datenschutz',
  description:
    'Datenschutzerklärung der ÆSTHETIX Content Agency. Informationen zur Datenverarbeitung gemäß DSGVO.',
...
export default function Datenschutz() {
  return (
    <div className="bg-[#F5F5F7] min-h-screen text-[#111111] font-sans">
      {/* Header */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-white/10 backdrop-blur-xl py-6 px-6 md:px-12 flex justify-between items-center border-b border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.08)]">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              David Jones
              <br />
              Gröbenzeller Straße 41, 82178 Puchheim
              <br />
